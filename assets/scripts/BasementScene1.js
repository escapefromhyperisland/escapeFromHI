class BasementScene1 extends Phaser.Scene {
    constructor(){
        super("Basement1")
    }
        ...
        //MOVEMENT
            ...
            this.fPlayer.anims.play('walk',true);
                ...
                if(this.fPlayer.x>=1200){
                    ...
                    this.scene.start('Basement2',{mind:this.mind});  
                }
                if(this.fPlayer.x==200){
                   
                    this.createPlayerSub("Holly Molly! Sci-Fi hall in the basement! should check the other side!");
